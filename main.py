...
class Main(Window):
    def __init__(self):
        ...
        self.login_rect = self.label_login.get_rect(center=(self.login_btn.rect.centerx, self.login_btn.rect.centery)) ##Obtener el centro del botón para colocar el texto
        ...
        self.register_rect = self.label_register.get_rect(center=(self.register_btn.rect.centerx, self.register_btn.rect.centery)) ##Obtener el centro del botón para colocar el texto
    ...
    def render(self):
            ...
            if self.login_btn.draw():
                ...
                self.running = False
                ##Logica para pasar a ventana de iniciar sesion
